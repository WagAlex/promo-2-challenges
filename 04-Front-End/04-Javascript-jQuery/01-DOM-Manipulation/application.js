...
function run_challenges() {
  ...
  $('#email').val('alexandre@tournaud.com');
 ...
 $('#email-hint').html('<strong>This is my email now</strong>');
  ...
  $('tbody').append('<tr><td>15</td><td>Equipe des golbutes</td><td>0</td></tr>');

  // Ex 7. Write some code to sum all points given to all teams
    // TODO: replace 0 with your sum result, keep the sum variable.
  var sum = 0;
  $('tr > td:nth-child(3)').each(function(idx, el){
